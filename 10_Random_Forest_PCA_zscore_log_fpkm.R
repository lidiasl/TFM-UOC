#####################################################################
  # Select genes applying PCA ZSCORE LOG FPKM
# Lidia Sainz
#####################################################################
...
set.seed(42)
PCA <- prcomp(as.matrix(zscore_log_fpkm[,colnames(zscore_log_fpkm)!="enfermedad_primaria"]), 
                   scale. = FALSE, 
                   center = FALSE)
...
saveRDS(transformacion_PCA, file="transformacion_PCA_zscore_log_FPKM.csv")
######################################
...
PCA_training <- PCA_training[, 1:25]
...
tic-toc #Time difference of 12.71011 mins
...
write.csv(bestTune_df, file="bestTune_df_PCA_zscore_log_fpkm.csv")
...
#22 components, mtry=3, ntree=1500, padj<0.001 log2FC>3
#Accuracy : 0.9434
#Kappa : 0.9412

#25 components, mtry=3, ntree=600, padj<0.0001 log2FC>5
#Accuracy : 0.9461 
#Kappa : 0.944
...
######################################
setwd("~/Desktop/LIDIA/TCGA_classification/TFM/Results/Random Forest Prueba")
saveRDS(tab_cm, file="tab_cm_train_RF_PCA_zscore_log_fpkm.rds")
...
zscore_log_FPKM_test_PCA <- zscore_log_FPKM_test_PCA[, 1:25]
...
######################################
setwd("~/Desktop/LIDIA/TCGA_classification/TFM/Results/Random Forest Prueba")
saveRDS(tab_cm_VAL, file="tab_cm_VAL_RF_PCA_zscore_log_fpkm.rds")
...
zscore_log_FPKM_MET500 <- zscore_log_FPKM_MET500[rownames(zscore_log_FPKM_MET500) %in% genes_list_0.0001_5,]
...
zscore_log_FPKM_MET500_PCA <- zscore_log_FPKM_MET500_PCA[, 1:25]
...
#22 componentes, mtry=3, ntree=1500, padj<0.001 log2FC>3
#Accuracy : 0
#Kappa : 0

#25 componentes, mtry=3, ntree=600, padj<0.0001 log2FC>5
#Accuracy : 0.4496
#Kappa : 0.3932
...
######################################
setwd("~/Desktop/LIDIA/TCGA_classification/TFM/Results/Random Forest Prueba")
saveRDS(tab_cm_MET500, file="tab_cm_MET500_RF_PCA_zscore_log_fpkm.rds")
