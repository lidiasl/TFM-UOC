#####################################################################
# RANDOM FOREST genes LASSO zscore log FPKM
#####################################################################
...
####
tunegrid <- expand.grid(mtry=seq(15,240,15))
...
tic-toc #Time difference of 2.768066 hours
...
write.csv(bestTune_df, file="bestTune_df_LASSO_zscore_log_fpkm.csv")
...
######################################
setwd(resultsDirectory)
saveRDS(tab_cm, file="tab_cm_train_RF_LASSO_zscore_log_fpkm.rds")
...
######################################
setwd(resultsDirectory)
saveRDS(tab_cm_VAL, file="tab_cm_VAL_RF_LASSO_zscore_log_fpkm.rds")
...
######################################
setwd(resultsDirectory)
saveRDS(tab_cm_MET500, file="tab_cm_MET500_RF_LASSO_zscore_log_fpkm.rds")
