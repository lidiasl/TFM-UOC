...
tic-toc #Time difference of 2.181817 hours
...
write.csv(bestTune_df, file="bestTune_df_LASSO.csv")

#### 
bestTune_df <- read.csv(file="bestTune_df.csv")
######################################
...
tab_cm_tabla <- tab_cm$table

accuracy_train <- sum(diag(tab_cm_tabla))/sum(tab_cm_tabla)
...
######################################
setwd(resultsDirectory)
saveRDS(tab_cm, file="tab_cm_train_RF_LASSO.rds")
...
######################################
setwd(resultsDirectory)
saveRDS(tab_cm_VAL, file="tab_cm_VAL_RF_LASSO.rds")
...
######################################
setwd(resultsDirectory)
saveRDS(tab_cm_MET500, file="tab_cm_MET500_RF_LASSO.rds")
